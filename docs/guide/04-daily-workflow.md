...
| 📁 **Materials** *(coming soon)* | Cross-course view of all registered materials. |
| 🤖 **AI engine** *(Phase 3)* | Configure providers, agents, skills. |
| ❓ **Questions** *(Phase 4-6)* | Generate, refine, promote. |

## Today's rhythm

For Phase 0-2.6 (what's shipped now):
...
In order of "what I'd recover first if my Mac died":
