...
flowchart TB
    ...
    classDef user fill:transparent,stroke:#C6664A,stroke-width:2px
    classDef api fill:transparent,stroke:#C6664A,stroke-width:2px
    classDef worker fill:transparent,stroke:#B8894A,stroke-width:2px
    classDef filter fill:transparent,stroke:#6B7280,stroke-width:2px
    classDef db fill:transparent,stroke:#6E9075,stroke-width:2px
    classDef queue fill:transparent,stroke:#8B7BB8,stroke-width:2px
    classDef fs fill:transparent,stroke:#6B7280,stroke-width:2px,stroke-dasharray:4 2
    classDef ui fill:transparent,stroke:#C6664A,stroke-width:2px
```
