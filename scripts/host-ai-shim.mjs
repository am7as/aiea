...
// Loopback only. This process spawns the host CLIs with permissive flags and takes
// working_dir from the request body, so binding it to every interface would hand
// arbitrary local code execution to anyone on the same network.
